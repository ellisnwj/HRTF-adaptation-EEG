...
duration = 0.2  # short chirps <0.05s introduce variability in low freq (4-5 kHz). improvement at 0.1s for kemar vsi
low_freq = 20
high_freq = 20000  # window of interest is 4-16
...
"""
file_name = 'VD_Earmolds_20.02.sofa'
...
hrtf.plot_tf(sources, n_bins=500, ear='left)
...
# ole_test molds on kemar
from matplotlib import pyplot as plt

fname='varvara_ears_free_23.09.sofa'
hrtf=slab.HRTF(Path.cwd() / 'data' / 'hrtf' / fname)
